...
public class VendorOpeningClosingTime implements Parcelable
{
    ...
    public final static Parcelable.Creator<VendorOpeningClosingTime> CREATOR = new Creator<VendorOpeningClosingTime>() {
        ...
        public VendorOpeningClosingTime[] newArray(int size) {
            return (new VendorOpeningClosingTime[size]);
        }
    ...
    public VendorOpeningClosingTime() {
    }
